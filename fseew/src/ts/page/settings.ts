...
import SSP        from '@fluentui/svg-icons/icons/link_32_color.svg?raw';
import BLACK_LIST from '@fluentui/svg-icons/icons/text_bullet_list_square_sparkle_32_color.svg?raw';
import CHECK      from '@fluentui/svg-icons/icons/search_sparkle_32_color.svg?raw';
...
export function entry(element: HTMLElement) {
    ...
    langSetting.nth(1).innerHTML = GLOBAL;
    ...
    translateLine.nth(1).innerHTML = TRANSLATE;
    ...
    passvbhashSetting.nth(1).innerHTML = PVH;
    ...
    spsyncpropSetting.nth(1).innerHTML = SSP;
    ...
    blackListSetting.nth(1).innerHTML = BLACK_LIST;
    ...
    appCheckSetting.nth(1).innerHTML = CHECK;
    ...
    modCheckSetting.nth(1).innerHTML = CHECK;
    ...
    feedbackLine.nth(1).innerHTML = FEEDBACK;
    ...
    aboutLine.nth(1).innerHTML = ABOUT;
